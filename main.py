# Vamos a hacer las funciones para la interfaz de consola
...
def registrar_mascota():
    ...
    if tipo == "perro":
        ...
        mascota = Perro(nombre, edad, salud, precio, raza, nivel_de_energia) # Instancia del perro
...
def registrar_producto():
    ...
    precio = float(input("Precio del prodcuto: "))
...
def mostrar_menu():
    ...
    print("5. Mostrar información sobre Mascotas")
    print("6. Mostrar información sobre Clientes")
    print("7. Mostrar información sobre Productos")
